...
```{r cars58}
# Calculate the adjusted probabilities by removing the effects of C1 to C20
categorized_combined_data <- categorized_combined_data %>%
...
final_clusters <- gmm_result$classification
...
cluster_to_ancestry <- c("4" = "EUR", "2" = "HIS", "3" = "AFR", "1" = "OTH", "5" = "OTH")
